...
*                                                             * This utility provides a functional alternative to template literals or JSX,                                               * with full TypeScript support for CSS properties and element types.                                                        *                                                             * @template K - HTML tag name key from HTMLElementTagNameMap  * @param {K} tagName - The HTML tag name (e.g., 'div', 'span', 'a', 'button')                                               * @param {Properties<string | number>} [styles={}] - CSS styles in camelCase format
* @param {number | boolean | string | Node | (number | boolean | string | Node)[]} [children] - Child nodes or text content * @returns {HTMLElementTagNameMap[K]} The created HTML element with proper type
